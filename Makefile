...
IMAGE                      := $(BASE_IMAGE)/timeline:$(SERVICE_VERSION)
...
BINARY_NAME                := timeline_service
TEMP_DIR                   := /var/tmp/meower/timeline
TEMP_BIN                   := ${TEMP_DIR}/bin
PROJECT_PKG                := github.com/Karzoug/meower-timeline-service
