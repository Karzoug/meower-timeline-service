...
func (c Client) ListFollowerIDs(ctx context.Context, userID xid.ID) ([]xid.ID, error) {
	ctx = grpc.ContextWithUserID(ctx, userID)
...
func (c Client) ListNotMutedFollowingIDs(ctx context.Context, userID xid.ID) ([]xid.ID, error) {
	ctx = grpc.ContextWithUserID(ctx, userID)
